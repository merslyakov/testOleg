...
c.prototype=b.prototype;a.M=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.sl=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Al;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.za}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
function Xh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||F("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.rl||F("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().ql:b=vd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=F("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=F("DELEGATED_SESSION_ID")));return d}
...
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new R("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",xl:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
...
;var lk=!1,mk,nk=0,ok=0,pk,qk=y.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:lk,Ia:mk,potentialEsfErrorCounter:ok,isIdbSupported:!!mk};z("ytNetworklessLoggingInitializationOptions",qk,void 0);
...
vk);if(!O("networkless_immediately_drop_sw_health_store")){c.B(8);break}return w(c,wk(),8);case 8:if(O("networkless_immediately_drop_all_requests"))return w(c,Wj(),0);c.B(0)}})})}
...
Mk();c=u(a.T);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.wl)){a=d.weight;break a}a=u(a.P);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ea(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Hk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.na[l.name])for(e=u(c.na[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
Sc:105350,Tc:131392,Vc:113533,Wc:93252,Xc:99357,Zc:94521,bd:114252,cd:113532,dd:94522,Yc:94583,ed:88E3,fd:93253,gd:93254,hd:94387,jd:94388,kd:93255,ld:97424,Uc:72502,md:110111,nd:76019,pd:117092,qd:117093,od:89431,rd:110466,sd:77240,td:60508,ud:73393,vd:113534,wd:92098,xd:131381,yd:84517,zd:83759,Ad:80357,Bd:86113,Cd:72598,Dd:72733,Ed:107349,Fd:124275,Gd:118203,Hd:117431,Id:117429,Jd:117430,Kd:117432,Ld:120080,Md:117259,Nd:121692,Od:132972,Pd:133051,Qd:132971,Rd:97615,Sd:31402,Td:84774,Ud:95117,Vd:98930,
Wd:98931,Xd:98932,Yd:43347,Zd:129889,ae:45474,be:100352,ce:84758,de:98443,ee:117985,ge:74613,he:74614,ie:64502,je:74615,ke:74616,le:122224,me:74617,ne:77820,oe:74618,pe:93278,qe:93274,re:93275,se:93276,te:22110,ue:29433,we:132295,ye:120541,Ae:82047,Be:113550,Ce:75836,De:75837,Ee:42352,Fe:84512,Ge:76065,He:75989,Ie:16623,Je:32594,Ke:27240,Le:32633,Me:74858,Oe:3945,Ne:16989,Pe:45520,Qe:25488,Re:25492,Se:25494,Te:55760,Ue:14057,Ve:18451,We:57204,Xe:57203,Ye:17897,Ze:57205,af:18198,bf:17898,cf:17909,
df:43980,ef:46220,ff:11721,gf:49954,hf:96369,jf:3854,kf:56251,lf:25624,mf:16906,nf:99999,pf:68172,qf:27068,rf:47973,sf:72773,tf:26970,uf:26971,vf:96805,wf:17752,xf:73233,yf:109512,zf:22256,Af:14115,Bf:22696,Cf:89278,Df:89277,Ef:109513,Ff:43278,Gf:43459,Hf:43464,If:89279,Jf:43717,Kf:55764,Lf:22255,Mf:89281,Nf:40963,Of:43277,Pf:43442,Qf:91824,Rf:120137,Sf:96367,Tf:36850,Uf:72694,Vf:37414,Wf:36851,Yf:124863,Xf:121343,Zf:73491,ag:54473,cg:43375,dg:46674,eg:32473,fg:72901,gg:72906,hg:50947,ig:50612,jg:50613,
kg:50942,lg:84938,mg:84943,ng:84939,og:84941,pg:84944,qg:84940,rg:84942,sg:35585,tg:51926,ug:79983,vg:63238,wg:18921,xg:63241,yg:57893,zg:41182,Ag:33424,Bg:22207,Cg:42993,Dg:36229,Eg:22206,Fg:22205,Gg:18993,Hg:19001,Ig:18990,Jg:18991,Kg:18997,Lg:18725,Mg:19003,Ng:36874,Og:44763,Pg:33427,Qg:67793,Rg:22182,Sg:37091,Tg:34650,Ug:50617,Vg:47261,Wg:22287,Xg:25144,Yg:97917,Zg:62397,ah:125598,bh:36961,dh:108035,eh:27426,fh:27857,gh:27846,hh:27854,ih:69692,jh:61411,kh:39299,lh:38696,mh:62520,nh:36382,oh:108701,
ph:50663,qh:36387,rh:14908,sh:37533,th:105443,uh:61635,vh:62274,wh:65702,xh:65703,yh:65701,zh:76256,Ah:37671,Bh:49953,Dh:36216,Eh:28237,Fh:39553,Gh:29222,Hh:26107,Ih:38050,Jh:26108,Lh:120745,Kh:26109,Mh:26110,Nh:66881,Oh:28236,Ph:14586,Qh:57929,Rh:74723,Sh:44098,Th:44099,Uh:23528,Vh:61699,Wh:59149,Xh:101951,Yh:97346,Zh:118051,ai:95102,bi:64882,ci:119505,di:63595,fi:63349,gi:95101,hi:75240,ii:27039,ji:68823,ki:21537,li:83464,mi:75707,ni:83113,oi:101952,ri:101953,ti:79610,vi:125755,wi:24402,xi:24400,
yi:32925,zi:57173,Ai:122502,Bi:64423,Ci:64424,Di:33986,Ei:100828,Fi:129089,Gi:21409,Hi:11070,Ii:11074,Ji:17880,Ki:14001,Mi:30709,Ni:30707,Oi:30711,Pi:30710,Qi:30708,Li:26984,Ri:63648,Si:63649,Ti:51879,Ui:111059,Vi:5754,Wi:20445,Yi:130975,Xi:130976,Zi:110386,aj:113746,bj:66557,cj:17310,dj:28631,ej:21589,fj:68012,gj:60480,hj:31571,ij:76980,jj:41577,kj:45469,lj:38669,mj:13768,nj:13777,oj:62985,pj:4724,qj:59369,rj:43927,sj:43928,tj:12924,uj:100355,xj:56219,yj:27669,zj:10337,wj:47896,Aj:122629,Bj:121258,
Cj:107598,Dj:127991,Ej:96639,Fj:107536,Gj:130169,Hj:96661,Ij:96658,Jj:116646,Kj:121122,Lj:96660,Mj:127738,Nj:127083,Oj:104443,Pj:96659,Qj:106442,Rj:63667,Sj:63668,Tj:63669,Uj:130686,Vj:78314,Wj:55761,Xj:127098,Yj:96368,Zj:67374,ak:48992,bk:49956,ck:31961,dk:26388,ek:23811,fk:5E4,gk:126250,hk:96370,ik:47355,jk:47356,kk:37935,lk:45521,mk:21760,nk:83769,pk:49977,qk:49974,rk:93497,sk:93498,tk:34325,uk:115803,vk:123707,wk:100081,xk:35309,yk:68314,zk:25602,Ak:100339,Bk:59018,Ck:18248,Dk:50625,Ek:9729,Fk:37168,
Gk:37169,Hk:21667,Ik:16749,Jk:18635,Kk:39305,Lk:18046,Mk:53969,Nk:8213,Ok:93926,Pk:102852,Qk:110099,Rk:22678,Sk:69076,Uk:100856,Vk:17736,Wk:3832,Xk:55759,Yk:64031,Zk:93044,al:93045,bl:34388,dl:17657,fl:17655,il:39579,jl:39578,kl:77448,ll:8196,ml:11357,nl:69877,ol:8197,pl:82039};function cl(){var a=kb(dl),b;return cf(new We(function(c,d){a.onSuccess=function(e){Ig(e)?c(new el(e)):d(new fl("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return a.join("")}
;var ul,vl=y.ytLoggingDocDocumentNonce_;vl||(vl=tl(),Ra("ytLoggingDocDocumentNonce_",vl));ul=vl;var wl={xe:0,kc:1,tc:2,Ch:3,ze:4,Tk:5,si:6,vj:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function xl(a){this.h=a}
...
gesturedVe:h.visualElement.getAsJson()}:h&&Zk(new yi("newScreen() parent element does not have a VE - rootVe",b));l&&(r.cloneCsn=l);l={F:n,U:q};k?Lh("screenCreated",r,k,l):Gk("screenCreated",r,l);ki(ni,new Il(q));var p=q}catch(A){al(A,{zl:b,rootVe:d,parentVisualElement:void 0,ul:e,yl:f,Ga:c.Ga});$k(A);return}Hl(p,b,c.layer,c.F);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(wl));for(f=b.next();!f.done;f=b.next())if(El(f.value)==e){b=!0;break a}b=

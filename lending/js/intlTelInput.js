			...
			function () {
				...
				_createClass(Iti, [{
					...
					value: function _setInitialState() {
						...
						// if we already have a dial code, and it's not a regionless Nanp, we can go ahead and set the
					...
					value: function _setFlag(countryCode) {
						...
						var title = countryCode ? "".concat(this.selectedCountryData.name, ": +").concat(this.selectedCountryData.dialCode) : "Chile: +56";
